...
> against (a) our own deep-read `papers/arxiv-2605.18613.md` and (b) the source PDF
...
- **SAME arch (faithful, line-by-line):** patching P=256→256× (stereo interleaved 512-d),
  ...
  1×1 conv, T5Gemma contrastive triplet, relativistic GAN. All match `arxiv-2605.18613.md`.
