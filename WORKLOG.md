...
## 2026-09-08 — GHOST-NOTE — NaN latents decode to full-scale noise; 165 cells quarantined, guard added
...
682 was ever rated and none is in the evaluator pool. The 15 arms now have GAPS where the noise was. Root cause NOT diagnosed — checkpoint, native length, `sample_size`/pad-clamp, cfg,
`set_lora_strength` and process cell-count all eliminated by isolation tests; parked for budget.
