...
| **`docs/train_lora_modular.md`** | **operator manual for `train_lora_modular.py`: every flag, default, tried values and expected effect; known-good recipes; do-it-yourself analysis (clip scan, trajectory, gauge drift)** (Kim 2026-09-23). Kept in sync by `Misc/check_train_manual.py` |
