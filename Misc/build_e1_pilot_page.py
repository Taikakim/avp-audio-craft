...
.hero{outline:2px solid #d90}.dorm{color:#667}.loading{outline:2px solid #fa5 !important}
</style></head><body>
<div id=bar>&#9654; <b id=np>click a row's ▶ to play</b> <span id=pos class=muted></span> <span id=ld class=muted style="color:#fa5"></span> <span class=muted>· switching keeps the playhead · loops until stopped · amber outline = loading</span></div>
<div id=wrap>
